...
public class AudioNegocio extends Thread {
	...
	/**	recording is used to flag if the AudioNegocio is recording.*/
	public boolean recording = false;
	/**  stopped is a flag to tell the AudioNegocio if it should record or not. */
	...
	/** It is necessary for the AudioNegocio to have access to a SaveFileChooser,
	 *  because the AudioNegocio needs to use the getNextFile() method both in
...
//            new krut.KRUT_GUI.SaveFileChooser();
	...
	/** Creates a new instance of AudioNegocio
	 *  Calling this constructor will create a AudioNegocio that uses
	 ...
	 *                      is created by this AudioNegocio.
	 */
...
//			e.printStackTrace();
		 ...
		 *  to the system clock, before the AudioNegocio compensates
